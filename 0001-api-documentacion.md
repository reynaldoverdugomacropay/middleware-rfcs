...
Las propuestas para el uso de la documentación dentro de los proyectos en desarrollo se encuentran: 
  ...
  La propuesta cuenta con varias Ventajas:
   ...
   -  Swagger es compatible con postman, esto es posible debido que al crear la UI genera un link donde se puede desgargar un archivo JSON que es el compatible con POSTMAN, lo cual facilita las pruebas locales.
